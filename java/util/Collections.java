 ...
 * Description: 集合工具类
 * All Rights Reserved.
 * @version 1.0 2018/8/28 0028 上午 9:58 by fengtan.zhang 创建
 */
...
public class Collections {
     ...
     * tuning parameters below determine the cutoff point(截止点) for what constitutes
    ...
    /**
     * Sorts the specified list into ascending order(升序), according to the
     ...
     * specified comparator.  All elements in the list must be <i>mutually(相互)
